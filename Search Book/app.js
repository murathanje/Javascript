let kitap1 = {isim : "Her şeyi Düşünme",yazar: "Anne Bogel",fiyat: 25, raf: "1.3.RAF"}

let kitap2 = {isim: "Hiçbir karşılaşma tesadüf değildir",yazar: "Hakan Mengüç",fiyat: 56,raf: "2.5.RAF"}

let kitap3 = {isim: "Dikili İlişkiler",yazar: "HAluk Tatar",fiyat: 35, raf: "3.3.RAF"}

let kitap4 = {isim: "İnsan Ne ile Yaşar?",yazar: "Tolstoy",fiyat: 43, raf: "4.4.RAF"}

let kitap5 = {isim: "Şeker Portakalı",yazar: "Jose Mauro de Vasconcelos",fiyat: 43, raf: "5.2.RAF"}
...
let kitapIsmi = prompt("Lütfen aramak istediğiniz kitabın ismini giriniz.");
...
if(rafKod != null){
    ...
    alert("Aradığınız kitap bulunmamaktadır.")
}
